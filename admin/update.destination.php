    ...
    <main class="container my-5">
        ...
        <div class="form-card">
            <form action="../logic/update.logic.php" method="post">
                ...
                <!-- Galeri Destinasi -->
                 <form action="../logic/add.gallery.logic.php" method="post"></form>
                <div class="gallery-section">
                    <h3>Galeri Destinasi</h3>
                    <p class="text-muted">Kelola foto-foto galeri untuk destinasi ini</p>

                    <!-- Form Tambah Gambar Galeri -->
                        <h5 class="mb-3">Tambah Gambar Baru</h5>
                        <form action="../logic/add.gallery.logic.php" method="post">
                            <input type="hidden" name="destination_id" value="<?= $data['id'] ?>">

                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="image_path" class="form-label">URL Gambar</label>
                                    <input name="image_path" type="url" class="form-control" id="image_path"
                            ...
                            <button type="submit" class="btn btn-success">
                                <i class="bi bi-plus-circle"></i> Tambah ke Galeri
                            </button>
                    </div>
